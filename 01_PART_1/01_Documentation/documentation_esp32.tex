...
\begin{titlepage}
	...
	{\Large \itshape Teil 1\\}
	\vspace{3cm}
	{\bfseries Eingereicht am: 03. März 2026\\}
	\vspace{0.5cm}
	\rule{10cm}{1pt}\\
	\vspace{0.5cm}
...
GPIO steht für \textbf{General Purpose Input/Output}. Dabei kann dieser entweder ein Eingang- oder Ausgangssignal repräsentieren. Es wird dazu genutzt, um mit weiteren einfachen Komponenten zu kommunizieren oder  Steuern.
\begin{figure}[htpb]
	\centering
	\caption{GPIO Aufbau}
	\includegraphics[height=0.5\textheight, keepaspectratio]{gpio-pin-theory.png}
\end{figure}
In dieser Grafik wird der Aufbau mit einer LED \& dem GPIO Port beschrieben. Die LED kann dann per Anweisung ein Stromsignal erhalten oder nicht. Dabei kann ein GPIO Port ausschließlich unter Spannung stehen, oder nicht.
\newpage
\subsection[UART]{Der Port UART}
UART steht für \textbf{Universal Asynchronous Receiver/Transmitter}. Es übersetzt Daten zwischen der seriellen \& paralleler Form.
\begin{figure}[htpb]
	\centering
	\caption{UART Aufbau}
	\includegraphics[height=0.5\textheight, width=\textwidth, keepaspectratio]{ESP32-UART-communication.jpg}
\end{figure}
\newpage
...
\begin{figure}[htpb]
	\centering
	\caption{I2C Aufbau}
	\includegraphics[height=0.5\textheight, width=\textwidth, keepaspectratio]{i2c-schema.jpg}
\end{figure}
\subsection[SPI]{Der Port SPI}
SPI steht für \textbf{Serial Peripheral Interface} und ist ein synchrones serielles Datenprotokoll, das von Mikrocontrollern zur Kommunikation mit einem oder mehreren Peripheriegeräten verwendet wird. Beispielsweise kommuniziert der ESP32-Board mit einem Sensor, der SPI unterstützt, oder mit einem anderen Mikrocontroller.
\begin{figure}[htpb]
	\centering
	\caption{SPI Aufbau}
	\includegraphics[height=0.5\textheight, width=\textwidth, keepaspectratio]{SPI-communication.jpg}
\end{figure}
...
\begin{figure}[htbp]
	\centering
	\caption{ESP32 Internal Structure}
	\includegraphics[width=\textwidth, keepaspectratio]{ESP32_Structure.pdf}
\end{figure}

\begin{figure}
	\centering
	\caption{ESP32 Topansicht}
	\includegraphics[height=0.5\textheight, keepaspectratio]{esp32_top-view.jpg}
\end{figure}

\begin{figure}
	\centering
	\caption{ESP32 Seitenansicht}
	\includegraphics[height=0.5\textheight, keepaspectratio]{esp32_side-view.jpg}
\end{figure}
