...
\begin{document}
	...
	def get_device_temp_and_humid():
		...
		return temp, humid
	\end{lstlisting}
	Mithilfe dieser Funktion, ist es uns möglich, die \textbf{Temperatur} und \textbf{Luftfeuchtigkeit} an dem \textbf{aktuellen Ort} zu bestimmen. Dafür sendet das Modul \textit{DHT22} seine Daten an den Pin \textbf{G4}, diesen aben wir zuvor Pinverteilung ESP32 definiert.
